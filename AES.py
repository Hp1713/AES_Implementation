...
message="This is the message that will be encrypted with AES"
...
def add_round_key(state,roundkey):
    ST=[]
    for i in range(16):
        ST.append(ord(state[i])^ord(roundkey[i]))
    return ST  
def KeyExpansionCore(inn,j):
    t=[]
...
print(shift_rows(str1))

print(add_round_key('1234567891234567','thisisakeyforaes'))
